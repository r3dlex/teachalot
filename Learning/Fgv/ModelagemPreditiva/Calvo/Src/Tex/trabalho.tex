...
% ---
\titulo{Trabalho de Árvore de Decisão}
...
\preambulo{Este trabalho trata-se de uma análise estatística feita sobre a base de dados Calvo, cujo objetivo é prever se indivíduo é \emph{Adimplente} ou \emph{Inadimplente}.}
% ---
