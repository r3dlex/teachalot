...
\usepackage{listings}			  % Listings e highlighting
...
\usepackage{longtable}      % Defines longtables usage
\usepackage{csvsimple}      % Defines automatic CSV extraction 
...
\addto\captionsportuguese{\renewcommand*{\refname}{Refer\^encias}}
...
% Defines a path to the table folder
\newcommand*{\tablePath}{Src/Table}
% ---

% ---
% Informações de dados para CAPA e FOLHA DE ROSTO
% ---
\titulo{Análise Ativos Imobiliários no Brasil}
\autor{André Ferreira Bem Silva \\ Augusto Gonçalves \\ Filpe Gomes Dias \\ Marcos Vinício Siqueira}
...
\instituicao{%
  ...
  \par
  Aplicações em Estatística Espacial
}
\tipotrabalho{Estudo de Caso}
\preambulo{Este é um estudo sobre a influência dos diversos fatores geoespaciais ou não sobre ativos imobiliários no mercado nacional.}
% ---
